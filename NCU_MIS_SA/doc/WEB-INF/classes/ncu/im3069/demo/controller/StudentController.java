...
public class StudentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String id = jsr.getParameter("Student_ID");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String email = jso.getString("Student_email");
        String password = jso.getString("Student_password");
        String name = jso.getString("Student_name");
        
        /** 取出該名會員之資料並封裝至 JSONsonArray 內 */
        /** 建立一個新的會員物件 */
        Student s = new Student(email, password, name);
        ...
        /** 透過MemberHelper物件的checkDuplicate()檢查該會員電子郵件信箱是否有重複 */
            ...
            /** 透過JsonReader物件回傳到前端（以字串方式） */
            jsr.response(resp, response);
            System.out.print("GO Back to forward");
        }
	}
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        String password = jso.getString("Student_password");
        String name = jso.getString("Student_name");
        int Student_ID = jso.getInt("Student_ID");
       
        /** 取出該名會員之資料並封裝至 JSONsonArray 內 */
        /** 透過傳入之參數，新建一個以這些參數之會員Member物件 */
        Student s = new Student(email, password, name, Student_ID);
